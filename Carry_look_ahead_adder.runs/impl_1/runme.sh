...
HD_PWD='F:/Digital System Design/Lab 2/Carry_look_ahead_adder/Carry_look_ahead_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladd4.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fulladd4.tcl -notrace
