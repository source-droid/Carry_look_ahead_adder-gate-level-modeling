...
HD_PWD='F:/Digital System Design/Lab 2/Carry_look_ahead_adder/Carry_look_ahead_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladd4.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fulladd4.tcl
